...
const CollectionDataCardInfo: FC<CollectionInfoPropsType> = ({ collection, isOwner }) => {
    ...
    return (
        <Box sx={{ pr: {lg: 3} }}>
            <Grid container spacing={2}>
                ...
                <Grid item container xs direction='column' alignItems="flex-start" justifyContent='center' gap={3} sx={{ mx: 3 }}>
