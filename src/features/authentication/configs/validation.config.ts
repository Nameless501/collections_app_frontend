...
export const signInValidationConfig = yup.object(signInValidationOptions).required();

export const signUpValidationConfig = yup.object(signUpValidationOptions).required();
