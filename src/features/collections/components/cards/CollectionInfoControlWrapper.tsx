...
const CollectionInfoControlWrapper: FC<CollectionInfoControlWrapperPropsType> = ({ collectionId, isEditable, handleEdit, children }) => {
    return (
        <Box
        ...
        >
            {children}
            {
                isEditable &&
                <Box
                    sx={{ position: 'absolute', display: 'flex', top: -5, right: -15, gap: 2 }}
                >
                    <CustomFab 
                        size='small'
                        color='primary'
